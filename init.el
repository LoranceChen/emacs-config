...
;;(add-hook 'after-save-hook (lambda () (haskell-process-reload)))
...
;;todo put to project emcas config
(setenv "PATH" (concat (getenv "PATH") ":~/project/haskell/test1126/my-project"))
;;===================
